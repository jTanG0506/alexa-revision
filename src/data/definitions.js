var definitions = {
  ...
  "factor ring": "let R be a ring, and let I be a proper ideal, the factor ring of R by I is the set of cosets of I, in the additive group R under addition, elements in this ring are of the form r plus I,\
                 where r are elements of R, and I is the proper ideal, the operations plus and times are defined as follows, r plus I, plus, s plus I, equals, r plus s, plus I, and, r plus I, times, s plus I,\
                 equals, r times s, plus I, so we are adding and multiplying cosets.",
  "maximial": "an ideal I of a ring R is maximal, if it is proper, and for any ideal J, with I being an ideal of J, and J being an ideal of R, then J equals I, or J equals R.",
  "prime ideal": "a proper ideal I of a commutative ring R, is prime, if whenever we have, R times S being in I, where R and S are elements of the ring R, then either R is in I, or S is in I."
};
